  ...
  return (
    <div className="flex flex-col gap-6 p-1">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Bu sahifa hozircha ishlab chiqilmoqda</p>
      </div>
      <div className="card bg-base-100 border border-base-200 shadow-sm">
        <div className="card-body items-center text-center py-16">
          ...
          <p className="text-base-content/40 text-sm mt-2">Tez orada bu funksiya mavjud bo'ladi</p>
        </div>
      </div>
    </div>
  );
