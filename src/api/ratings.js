...
export const getGroupRatings = (groupId) =>
  api.get(`/ratings/group/${groupId}`);
export const updateDayRatings = (groupId, data) =>
  api.put(`/ratings/group/${groupId}/day`, data);
...
export const upsertDayRating = (
  groupId,
  { studentId, day, month, year, score, comments },
) =>
  api.put(`/ratings/group/${groupId}/day`, {
    studentId,
    day,
    month,
    year,
