...
export const getGroupById = (id, params) =>
...
export const enrollInGroup = (groupId) => api.post(`/groups/${groupId}/enroll`);
...
export const getFreeRooms = ({ days, time }) =>
  api.get("/rooms/free", { params: { days, time } });
